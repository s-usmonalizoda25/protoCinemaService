...
const (
	UserService_Add_FullMethodName     = "/user.v1.UserService/Add"
...
type UserServiceClient interface {
	Add(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error)
...
func (c *userServiceClient) Add(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
...
type UserServiceServer interface {
	Add(context.Context, *CreateUserRequest) (*CreateUserResponse, error)
...
func (UnimplementedUserServiceServer) Add(context.Context, *CreateUserRequest) (*CreateUserResponse, error) {
...
func _UserService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Add(ctx, req.(*CreateUserRequest))
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protoCinemaProject/proto/user/user.proto",
}
